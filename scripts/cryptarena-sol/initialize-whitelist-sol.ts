/**
 * Initialize Whitelist for Cryptarena SOL
 * 
 * Sets up all tokens with real mainnet addresses:
 * - 14 Solana tokens
 * - 5 EVM tokens (ETH, UNI, LINK, PEPE, SHIB)
 * 
 * Usage: npx ts-node scripts/initialize-whitelist-sol.ts
 */
...
async function main() {
  console.log("\n" + "═".repeat(80));
  console.log("🪙 INITIALIZE WHITELIST - Cryptarena SOL");
